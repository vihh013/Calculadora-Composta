...
function calcularregrade3() 
{
    ...
    quartovalor = document.getElementById('4Vl').value
    quintovalor = document.getElementById('5Vl').value
...
result = (terceirovalor * quartovalor * quintovalor) / (primeirovalor * segundovalor);      
